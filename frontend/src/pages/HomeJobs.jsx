                        ...
                        {!isLoggedIn ? (
                            <>
                                <button
                                    ...
                                    className="hidden rounded-lg px-4 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 hover:text-indigo-600 sm:block"
                                >
                                    Login
                                </button>
                ...
                {filteredJobs.length === 0 ? (
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white px-6 py-16 text-center">
                        ...
                        <p className="mt-2 text-sm text-slate-500">
                            Try changing your search or explore
                            another category.
                        </p>
                    ...
                    <div className="relative w-full max-w-md rounded-2xl bg-white p-7 shadow-2xl">
                        ...
                        <div className="mt-6 space-y-3">
                            ...
                            <button
                                ...
                                className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
                            >
                                <UserPlus size={18} />
                                Create an Account
                            </button>
                        ...
                        <div className="mt-5 flex items-center justify-center gap-1.5 text-xs text-slate-400">
                            ...
                            <span>
                                Join JobBridge and start your career
                                journey.
                            </span>
                        </div>
                    </div>
