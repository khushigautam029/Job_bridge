                                ...
                                <div className="grid lg:grid-cols-[0.8fr_1.2fr]">
                                    ...
                                    <div className="p-7 sm:p-10">
                                        ...
                                        <form className="mt-7 space-y-5">
                                            ...
                                            {accountType === "candidate" && (
                                                <>
                                                    <div>
                                                        ...
                                                        <select className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-600 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100">
                                                            <option value="">
                                                                Select
                                                                qualification
                                                            </option>
                                            ...
                                            <button
                                                type="submit"
                                                className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                            >
                                                Create{" "}
                                                {accountType === "candidate"
                                                    ? "Candidate"
